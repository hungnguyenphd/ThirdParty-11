...
#define PRTE_CONFIGURE_CLI " \'--disable-option-checking\' \'--prefix=/opt/ThirdParty-11/platforms/linux64Gcc/openmpi-5.0.2\' \'--enable-prte-ft\' \'--with-proxy-version-string=5.0.2\' \'--with-proxy-package-name=Open MPI\' \'--with-proxy-bugreport=https://www.open-mpi.org/community/help/\' \'--enable-prte-prefix-by-default\' \'--disable-pmix-lib-checks\' \'--with-pmix-extra-libs=/opt/ThirdParty-11/openmpi-5.0.2/3rd-party/openpmix/src/libpmix.la\' \'--disable-orterun-prefix-by-default\' \'--enable-shared\' \'--disable-static\' \'--enable-mpi-thread-multiple\' \'--libdir=/opt/ThirdParty-11/platforms/linux64Gcc/openmpi-5.0.2/lib64\' \'--enable-mpi-fortran=none\' \'--disable-mpi-profile\' \'--with-sge\' \'CC=gcc\' \'CFLAGS=-m64 -fPIC\' \'LDFLAGS=-m64\' \'CPPFLAGS= -I/opt/ThirdParty-11/openmpi-5.0.2/3rd-party/openpmix/include -I/opt/ThirdParty-11/openmpi-5.0.2/3rd-party/openpmix/include -I/opt/ThirdParty-11/openmpi-5.0.2/3rd-party/openpmix/ -I/opt/ThirdParty-11/openmpi-5.0.2/3rd-party/openpmix/\' \'CXX=g++\' \'CXXFLAGS=-m64 -fPIC -std=c++0x\' \'PKG_CONFIG_PATH=/opt/intel/oneapi/vtune/2023.2.0/include/pkgconfig/lib64:/opt/intel/oneapi/tbb/2021.10.0/env/../lib/pkgconfig:/opt/intel/oneapi/mpi/2021.10.0/lib/pkgconfig:/opt/intel/oneapi/mkl/2023.2.0/lib/pkgconfig:/opt/intel/oneapi/ippcp/2021.8.0/lib/pkgconfig:/opt/intel/oneapi/dpl/2022.2.0/lib/pkgconfig:/opt/intel/oneapi/compiler/2023.2.0/lib/pkgconfig\' \'--cache-file=/dev/null\' \'--srcdir=.\'"

/* Date when PMIx was built */
#define PRTE_CONFIGURE_DATE "Thu Mar 28 01:51:21 UTC 2024"

/* Hostname where PMIx was built */
#define PRTE_CONFIGURE_HOST "Hung-MLFM"

/* User who built PMIx */
#define PRTE_CONFIGURE_USER "hung"
...
#define PRTE_IDENT_STRING "3.0.3rc1"
...
#define PRTE_PACKAGE_STRING "Open MPI hung@Hung-MLFM Distribution"
...
#define PRTE_PROXY_VERSION_STRING "5.0.2"
...
#define PRTE_RELEASE_VERSION 3

/* The repository version PMIx Reference Run-Time Environment */
#define PRTE_REPO_REV "2024-03-28"

...
#define PMIX_CONFIGURE_CLI " \'--disable-option-checking\' \'--prefix=/opt/ThirdParty-11/platforms/linux64Gcc/openmpi-5.0.2\' \'--without-tests-examples\' \'--enable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--disable-orterun-prefix-by-default\' \'--enable-shared\' \'--disable-static\' \'--enable-mpi-thread-multiple\' \'--libdir=/opt/ThirdParty-11/platforms/linux64Gcc/openmpi-5.0.2/lib64\' \'--enable-mpi-fortran=none\' \'--disable-mpi-profile\' \'--with-sge\' \'CC=gcc\' \'CFLAGS=-m64 -fPIC\' \'LDFLAGS=-m64\' \'CXX=g++\' \'CXXFLAGS=-m64 -fPIC -std=c++0x\' \'PKG_CONFIG_PATH=/opt/intel/oneapi/vtune/2023.2.0/include/pkgconfig/lib64:/opt/intel/oneapi/tbb/2021.10.0/env/../lib/pkgconfig:/opt/intel/oneapi/mpi/2021.10.0/lib/pkgconfig:/opt/intel/oneapi/mkl/2023.2.0/lib/pkgconfig:/opt/intel/oneapi/ippcp/2021.8.0/lib/pkgconfig:/opt/intel/oneapi/dpl/2022.2.0/lib/pkgconfig:/opt/intel/oneapi/compiler/2023.2.0/lib/pkgconfig\' \'--cache-file=/dev/null\' \'--srcdir=.\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Thu Mar 28 01:51:11 UTC 2024"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "Hung-MLFM"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "hung"
...
#define PMIX_PACKAGE_STRING "PMIx hung@Hung-MLFM Distribution"

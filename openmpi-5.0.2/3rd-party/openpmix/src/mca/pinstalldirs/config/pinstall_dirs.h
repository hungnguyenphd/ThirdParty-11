...
#define PMIX_INSTALL_PREFIX "/opt/ThirdParty-11/platforms/linux64Gcc/openmpi-5.0.2"
...
/* The directory for object files and libraries of object code. Do not
   ...
   $(libexecdir) instead. */
#define PMIX_LIBDIR "/opt/ThirdParty-11/platforms/linux64Gcc/openmpi-5.0.2/lib64"

...
my $my_compiler = "";
my $mpi_jar   = "/opt/ThirdParty-11/platforms/linux64Gcc/openmpi-5.0.2/lib64/mpi.jar";
my $shmem_jar = "/opt/ThirdParty-11/platforms/linux64Gcc/openmpi-5.0.2/lib64/shmem.jar";

...
#define OPAL_CONFIGURE_CLI " \'--prefix=/opt/ThirdParty-11/platforms/linux64Gcc/openmpi-5.0.2\' \'--disable-orterun-prefix-by-default\' \'--enable-shared\' \'--disable-static\' \'--enable-mpi-thread-multiple\' \'--libdir=/opt/ThirdParty-11/platforms/linux64Gcc/openmpi-5.0.2/lib64\' \'--enable-mpi-fortran=none\' \'--disable-mpi-profile\' \'--with-sge\'"
